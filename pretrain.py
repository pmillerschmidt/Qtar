...
class TrainingManager:
    ...
    def train(self, qtar):
        """Train with curriculum learning and monitoring"""
    ...
    def _train_epoch(self, qtar, episodes):
        ...
        # Create metrics dictionary with explicit epoch number
        metrics = {
    ...
    def _calculate_motif_metrics(self, env):
        """Calculate comprehensive musical metrics"""
    ...
    def _calculate_note_entropy(self, env):
        """Calculate entropy of note distribution"""
    ...
    def _calculate_rhythm_entropy(self, env):
        """Calculate entropy of rhythm distribution"""
    ...
    def _check_completion(self, epoch, avg_reward, stability):
        """Check if training completion criteria are met"""
