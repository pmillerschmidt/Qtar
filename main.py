...
def analyze_melody(solo):
    """Analyze musical characteristics of the generated solo"""
    analysis = {}
...
def find_patterns(sequence, min_length=3):
    """Find repeated patterns in the melody"""
...
def format_note(note):
    """Format note with octave indication"""
    note_names = ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B']
    octave = note // 12 + 4  # Adjust octave to standard MIDI octave numbering
...
def main():
    ...
    # Generate and analyze multiple solos
    best_solo = None
...
def evaluate_solo(analysis):
    """Score a solo based on its musical characteristics"""
    score = 0
